    ...
    <header className="sticky top-0 z-50 border-b border-medical-blue-100 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-4 lg:flex">
          ...
          <Link
            href="/contatti/"
            className="inline-flex items-center justify-center rounded-full bg-aqua-accent-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-aqua-accent-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-aqua-accent-700"
          >
            Richiedi Visita
          </Link>
        </div>
        ...
        >
          ...
          <div className="mt-4 flex flex-col gap-3">
            ...
            <Link
              href="/contatti/"
              onClick={() => setMenuOpen(false)}
              className="inline-flex items-center justify-center rounded-full bg-aqua-accent-600 px-5 py-3 text-base font-semibold text-white shadow-sm transition-colors hover:bg-aqua-accent-700"
            >
              Richiedi Visita
            </Link>
          </div>
